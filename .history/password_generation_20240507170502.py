...
if special>=0:
   ...
   k=upper_case+lower_case+digits+special
   print(f"your selection for lengths of Uppercase+Lowercase+Digits+special characters not equal to length l  i.e.,{k}!={l}")
